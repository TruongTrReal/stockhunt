            ...
            for cost in cs["cost_grid"]:
                ...
                for i, name in enumerate(names):
                    ...
                    rows.append({
                        ...
                        "legacy_gate_ir": g_ir, "legacy_gate_breadth": g_breadth,
                        "legacy_gate_headroom": g_head, "legacy_gate_t": g_t,
                        "legacy_passed": int(g_ir) + int(g_breadth) + int(g_head) + int(g_t),
                ...
                baseline = {
                    ...
                    "legacy_gate_ir": False, "legacy_gate_breadth": False, "legacy_gate_headroom": False,
                    "legacy_gate_t": False, "legacy_passed": 0,

"""Fit a line to log price - constant growth - and extend it one bar."""
...
RULE = 'Fit a line to log price - constant growth - and extend it one bar.'
SOURCE = "megacellar '164 Trading Strategy Browser' (megacellar-browser.onrender.com), 'LogLinearFit'"
FAMILY = 'trend'
DRAFT = False
ANCHOR = False
CLASSES = None
...
What the source published
    Fits a linear regression to the logarithm of recent prices and extrapolates this
    trend one step forward, then converts back to price, modeling exponential
    growth/decay.

"""Fit a line to the window and extend it one bar."""
...
RULE = 'Fit a line to the window and extend it one bar.'
SOURCE = "megacellar '164 Trading Strategy Browser' (megacellar-browser.onrender.com), 'LinearTrendExtrapolation'"
FAMILY = 'trend'
DRAFT = False
ANCHOR = False
CLASSES = None
...
What the source published
    Fits a linear trend to recent prices and extrapolates this trend one step forward to

"""Predict the window median - the plainest mean-reversion rule in the batch."""

from __future__ import annotations

import numpy as np

from strategies._forecast import (expose, rmedian, win)

RULE = 'Predict the window median - the plainest mean-reversion rule in the batch.'
SOURCE = "megacellar '164 Trading Strategy Browser' (megacellar-browser.onrender.com), 'MedianReversion'"
FAMILY = 'reversion'
DRAFT = False
ANCHOR = False
CLASSES = None
...
What the source published
    Predicts that the price will revert to the median price observed in the recent
    window.

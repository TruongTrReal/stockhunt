"""Fade the trend in the z-score series rather than in the price."""

from __future__ import annotations

import numpy as np

from strategies._forecast import (expose, lin, rmean, rstd, safe_div, win)

RULE = 'Fade the trend in the z-score series rather than in the price.'
SOURCE = "megacellar '164 Trading Strategy Browser' (megacellar-browser.onrender.com), 'RollingWindowZScoreReversion'"
FAMILY = 'reversion'
DRAFT = False
ANCHOR = False
CLASSES = None
...
What the source published
    Calculates z-scores for prices in the window and fits a linear trend to these
    z-scores. Predicts mean reversion based on `current * (1 - slope_of_z_scores / 10)`.

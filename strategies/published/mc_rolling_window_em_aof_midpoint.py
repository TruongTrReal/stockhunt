"""An EMA of the window's own high-low midpoint."""

from __future__ import annotations

import numpy as np

from strategies._forecast import (ema, expose, rmax, rmin, win)

RULE = "An EMA of the window's own high-low midpoint."
SOURCE = "megacellar '164 Trading Strategy Browser' (megacellar-browser.onrender.com), 'RollingWindowEMAofMidpoint'"
FAMILY = 'reversion'
DRAFT = False
ANCHOR = False
CLASSES = None
...
What the source published
    Calculates an Exponential Moving Average (EMA) of the historical high-low midpoints
    of the window for each asset. The latest EMA midpoint is the prediction.
